...
//        val toolbarHomeBinding = ToolbarHomeBinding.inflate(LayoutInflater.from(requireContext()))
//        toolbarHomeBinding.searchView.clearFocus()
...
//        homeBoundLayout.recyclerView.adapter = ItemAdapter(this, list)
    }
